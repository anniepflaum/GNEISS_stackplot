...
B_E_STACKPLOT_DATA_NPZ = SCRIPT_DIR / "b_e_field_components_data.npz"
ROCKET_COLORS = {
    "397": "tab:blue",
    "398": "tab:orange",
}
...
def export_b_e_field_plot_data_csv(output_path: str | Path):
    ...
    with output_path.open("w", newline="") as csv_file:
        ...
        for series in metadata:
            ...
            for time_value, data_value in zip(time_s, values):
                writer.writerow(
                    {
                        "panel": series["panel"],
...
def plot_b_north_e_east(
    ...
    """Plot B north as solid lines and E east as dashed lines for both rockets."""
...
def plot_b_east_e_north(
    ...
    """Plot B east as solid lines and E north as dashed lines for both rockets."""
    fig, b_ax = plt.subplots(figsize=(10, 5))
    e_ax = b_ax.twinx()
    put_left_axis_above_twin(b_ax, e_ax)
...
if __name__ == "__main__":
    plot_b_e_field_components(show=True)
